...
job_descrp =  "mrtrix"
sbatch_folder_path = BD+"/mrtrix_amd/"+job_descrp + '_sbatch/'
...
list_folders_path ='#####/jacques/AMD_data/'
#list_folders_path = '/Volumes/Data/Badea/Lab/jacques/AMD_data/'
...
conn_path = '+++++/mouse/mrtrix_amd/connectome/'
#conn_path = '/Volumes/Data/Badea/Lab/mouse/mrtrix_amd/connectome/'
...
for subj in list_of_subjs:
    ...
    #nib.load(fmri_file)
    python_command = "python ++++/mrtrix_amd/main_trc_conn.py "+subj
